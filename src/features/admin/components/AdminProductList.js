          ...
          <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 rounded-lg py-2">
            <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-4">
              <Link
                ...
                className="rounded-lg py-4 mx-10 bg-green-700 px-6 text-md font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
                Add New Product
              </Link>
            ...
            <section aria-labelledby="products-heading" className="pb-24 pt-6">
              ...
              <div className="grid grid-cols-2 gap-x-4 gap-y-5 lg:grid-cols-4 ">
                {/* Filters */}
                <form className="hidden lg:block border-x-2 px-5 ">
                  {filters.map((section) => (
                    <Disclosure
                      as="div"
                      key={section.id}
                      className="border-b border-gray-200 py-6 b"
                    >
                      {({ open }) => (
                        <>
                          ...
                          <div>
                                  ...
                                  <div>
                                    <h3 className="text-md text-gray-700">
                                      <a href={product.thumbnail}>
                                        ...
                                        />
                                        <p className="font-semibols font-serif text-md">
                                          {product.title}
                                        </p>
                                      </a>
                                    </h3>
                                    <p className="-mt-0.5 text-sm font-semibold font-sans text-gray-600">
                                      ( {product.brand} )
                                    </p>
                                  </div>
                                  <div>
                            ...
                            <div className="mt-5">
                              <Link
                                ...
                                className="px-4 rounded-md bg-indigo-700 ml-[25%] py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                              >
                                Edit Product
                              </Link>
                            </div>
